...
xmlhttp.onreadystatechange = function () {
  if (this.readyState == 4 && this.status == 200) {
    ...
    var daily = data[0]['data'][1][1];
    console.log(daily); //logs todays date e.g. 07-Mar-2023 19:00 GMT
    //Gotta splice '-2023 19:00 GMT' somehow

    /**
     * imo we can map out the x-axis with a 30 day span here
     * once that map is created, within this if statement,
     * the var time or daily will represent the entire x-axis
     *
